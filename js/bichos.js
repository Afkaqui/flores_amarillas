...
/* ============================================================
   Fauna del jardín: abejas y mariposas.
   Las dos van de flor en flor; la mariposa además se posa.
   ============================================================ */
...
/* ============================================================
   Base: bicho que elige flores y se mueve hacia ellas
   ============================================================ */
class Bicho extends THREE.Group {
  ...
  /*
   * Se rehace la orientación entera cada cuadro a partir de la última
   * dirección buena. Antes el alabeo se sumaba sobre la rotación anterior y,
   * cuando el bicho casi se frenaba, seguía girando solo.
   */
...
/* ============================================================
   Abeja: zumba alrededor de la flor y se va a otra
   ============================================================ */
...
/* ============================================================
   Mariposa: aletea, planea y a veces se posa en una flor
   ============================================================ */
const PALETAS = [
