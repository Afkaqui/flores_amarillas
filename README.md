...
El perfil ligero se activa con memoria informada de hasta 4 GB, ahorro de datos o hasta cuatro hilos en escritorio. Usa 1.800 hojas de pasto, 24 flores de fondo y 30 FPS, sin sombras ni bloom, con resolución mínima de un píxel por píxel CSS y suavizado de bordes. Una pantalla táctil o pequeña ya no significa baja calidad: el perfil móvil general usa densidad de hasta 2, 5.000 hojas de pasto, 36 flores, sombras de 1024 y hasta 60 FPS, sin los pases HDR de escritorio. La ausencia de deviceMemory en Safari y el número de hilos de un móvil no lo rebajan automáticamente.

Cada 90 muestras lentas se aplica un solo ajuste: primero 30 FPS, después se retiran sombras y postprocesado, y sólo después se reduce la resolución con un mínimo de 1,25 en los perfiles móvil y escritorio. Las pausas del editor y las pestañas ocultas no cuentan como lentitud. El postprocesado de escritorio usa un destino con MSAA de hasta cuatro muestras; el suavizado del canvas por sí solo no se aplica a ese destino. El ramo conserva sus flores y animación, y las flores del fondo siguen agrupadas por material.

Las abejas acompañan las flores del ramo activo y, al volver al jardín, buscan flores cercanas. Hay 3 en el perfil ligero, 4 en móvil y 6 en escritorio. Las corolas del campo agrupado conservan sus coordenadas como destinos aunque sus objetos originales no tengan padre en la escena. El vuelo amortigua la velocidad según el tiempo transcurrido para mantener un comportamiento similar a 30 y 60 FPS; respeta las pausas del editor, las pestañas ocultas y la preferencia de movimiento reducido.

Revisión de esta corrección en BrowserOS a 440 × 904 CSS: buffer de 880 × 1808, antialias activo y sombras, 516 llamadas en el fotograma observado. Son comprobaciones de renderizado local; no equivalen a una prueba física ni medición de FPS en un iPhone 16 Pro Max. Las mediciones históricas siguientes corresponden a la optimización anterior.
